...
const themes = {
  ...
  p15: { '--bg':'#182030','--bg2':'#1e2840','--bg3':'#24304c','--panel':'#2a3858','--border':'rgba(72,152,255,0.25)','--accent':'#4898ff','--accent2':'#40e0cc','--accent3':'#78b8ff','--text':'#e8f0ff','--muted':'#7898c0','--dim':'#303858','--glow1':'rgba(72,152,255,0.1)','--glow2':'rgba(64,224,204,0.08)','--grid':'rgba(60,120,200,0.04)' },
  p16: { '--bg':'#1a2c2a','--bg2':'#203430','--bg3':'#263c38','--panel':'#2c4440','--border':'rgba(56,208,180,0.25)','--accent':'#38d0b4','--accent2':'#ffb840','--accent3':'#58e0c8','--text':'#e8fff8','--muted':'#78b0a8','--dim':'#384844','--glow1':'rgba(56,208,180,0.1)','--glow2':'rgba(255,184,64,0.08)','--grid':'rgba(48,180,160,0.04)' },
  p17: { '--bg':'#141c2c','--bg2':'#1a2438','--bg3':'#202c44','--panel':'#263450','--border':'rgba(56,192,240,0.22)','--accent':'#38c0f0','--accent2':'#7050f0','--accent3':'#60d0ff','--text':'#e4f2ff','--muted':'#6888b0','--dim':'#2e3c54','--glow1':'rgba(56,192,240,0.1)','--glow2':'rgba(112,80,240,0.08)','--grid':'rgba(40,150,200,0.04)' },
  p18: { '--bg':'#1c2630','--bg2':'#222e38','--bg3':'#283642','--panel':'#2e3e4e','--border':'rgba(112,208,255,0.25)','--accent':'#70d0ff','--accent2':'#ff7060','--accent3':'#90e0ff','--text':'#e8f4ff','--muted':'#7090a8','--dim':'#344050','--glow1':'rgba(112,208,255,0.1)','--glow2':'rgba(255,112,96,0.08)','--grid':'rgba(80,160,200,0.04)' }
};
...
window.addEventListener('DOMContentLoaded', () => {
  const saved = localStorage.getItem('gb-theme') || 'p17';
  setTheme(saved);
